...
if not, just open an issue on [GitHub](https://github.com/leeguooooo/fuck) with
the following basic information:
  - the output of `fuck --version` (something like `Fuck 3.1 using
    Python 3.5.0`);
  - your shell and its version (`bash`, `zsh`, *Windows PowerShell*, etc.);
  - your system (Debian 7, ArchLinux, Windows, etc.);
  - how to reproduce the bug;
  - the output of Fuck with `FUCK_DEBUG=true` exported (typically execute
    `export FUCK_DEBUG=true` in your shell before Fuck);
...
repository](https://github.com/leeguooooo/fuck) for new rules, new features, bug
fixes, etc.
