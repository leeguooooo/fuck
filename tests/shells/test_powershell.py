...
import pytest
from fuck.shells import Powershell
...
class TestPowershell(object):
    ...
    def Popen(self, mocker):
        mock = mocker.patch('fuck.shells.powershell.Popen')
        return mock
    ...
    def test_app_alias(self, shell):
        ...
        assert 'Get-Command fuck -CommandType Application' in shell.app_alias('fuck')
