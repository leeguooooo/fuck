...
from fuck.exceptions import EmptyCommand
...
class TestCommand(object):
    ...
    def Popen(self, monkeypatch):
        ...
        monkeypatch.setattr('fuck.output_readers.rerun.Popen', Popen)
        return Popen

    @pytest.fixture(autouse=True)
    def prepare(self, monkeypatch):
        monkeypatch.setattr('fuck.output_readers.rerun._wait_output',
                            lambda *_: True)
