...
from fuck.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('fuck.output_readers.rerun.Process')
    ...
    @patch('fuck.output_readers.rerun._wait_output', return_value=False)
    @patch('fuck.output_readers.rerun.Popen')
    ...
    @patch('fuck.output_readers.rerun._wait_output')
    ...
    @patch('fuck.output_readers.rerun._kill_process')
    ...
    @patch('fuck.output_readers.rerun.logs')
